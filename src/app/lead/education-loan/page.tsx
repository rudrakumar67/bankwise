...
import AddNewEducationLoan from "../../common/Widget/Lead/EducationLoan/Modals/AddNewEducationLoan";
  ...
  return (
    <div className='px-6'>
        <div className="flex justify-center z-50 backdrop-blur">
            ...
            <AddNewEducationLoan isOpen={addNewModal} onClose={closeAddNewModal}/>
        ...
        <div className="wrapper">
            <div className="flex h-6 justify-between my-1">
                ...
                Education Loan <ChevronRightIcon className='h-2.5 w-2.5 my-auto mx-1' /> List
                </div>
            </div>
            <Tools/>
        </div>
