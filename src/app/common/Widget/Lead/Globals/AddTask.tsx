...
const AddTask: NextPage<AddTaskProps> = ({isOpen , onClose}) => {      
    ...
    return(
        <div id="extralarge-modal" className={`flex justify-center fixed z-50 ${isOpen ? 'animate-fade-down animate-duration-750 animate-delay-100'  : 'hidden'} w-11/12 p-4 overflow-x-hidden overflow-y-auto max-h-full ransition-opacity animated fadeIn`}>
